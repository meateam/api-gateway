...
func init() {
	...
	viper.SetDefault(configUploadService, ":8081")
	viper.SetDefault(configDelegationService, ":8091")
	viper.SetDefault(configDocsSecret, "docs@drive")
	viper.SetDefault(configDownloadService, ":8082")
	viper.SetDefault(configFileService, ":8083")
	viper.SetDefault(configUserService, ":8086")
	viper.SetDefault(configPermissionService, ":8087")
	viper.SetDefault(configPermitService, ":8092")
	viper.SetDefault(configSearchService, ":8088")
	viper.SetDefault(configSpikeService, ":8090")
	viper.SetDefault(configGotenbergService, ":8089")
	viper.SetDefault(configSecret, "pandora@drive")
	viper.SetDefault(configAuthURL, "http://localhost:8084/auth/login")
