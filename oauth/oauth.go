...
func (m *Middleware) dropboxAuthorization(ctx *gin.Context, requiredScope string) error {
	...
	ctx.Set(ContextAppKey, DropboxAuthTypeValue)
...
// Later, it extracts the scopes array from the token and cheks weather the required scope is in the scope array.
